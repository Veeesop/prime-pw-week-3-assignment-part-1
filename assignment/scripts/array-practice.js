...
let favoriteFoods = ["pesto", "brisket", "wings"];
...
favoriteFoods.push("cool ranch doritos");
console.log("Added a food the end", favoriteFoods);
...
favoriteFoods.splice(1, 1, "green beans");
